    ...
    <header className="bg-white fixed top-0 left-0 right-0 z-50 lg:mx-2 lg:mt-2 lg:rounded-2xl shadow-xl border border-gray-300">
      <div className="px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          {/* Logo */}
          <Link href="/volunteer/dashboard" className="flex items-center gap-1.5 flex-shrink-0">
          ...
          <div className="flex items-center gap-1.5 sm:gap-2 flex-shrink-0">
            ...
            >
              ...
              {unreadCount > 0 && (
                <span className="absolute top-0 right-0 sm:top-0.5 sm:right-0.5 min-w-[16px] h-4 px-0.5 bg-red-500 text-white text-[10px] font-bold rounded-full flex items-center justify-center leading-none">
            ...
            {/* User Profile */}
            <Link href="/volunteer/profile" className="flex items-center gap-1.5 hover:opacity-80 transition-opacity">
              {user.avatarUrl ? (
