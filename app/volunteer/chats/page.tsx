      ...
      <div className="min-h-screen bg-green-50">
        ...
        <DynamicContent maxWidth="max-w-3xl">
          <div className="mb-6">
            ...
            <p className="text-gray-500 mt-1 text-sm">Чаты создаются автоматически, когда набор в проект завершён</p>
          </div>
          ...
          {chats.length === 0 ? (
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-12 text-center">
              ...
              <p className="text-gray-500 text-sm">Вступите в проект — чат появится, когда набор завершится</p>
            </div>
          ) : (
