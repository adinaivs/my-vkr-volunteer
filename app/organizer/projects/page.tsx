        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 mb-6">
          ...
          <div className="p-8">
            ...
            <div className="text-center py-12">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-3">У вас пока нет проектов</h3>
                  ...
                  <div>
                    ...
                    <div className="flex gap-2 mb-3">
                      ...
                      >
                        ...
                        <option value="Работа с детьми">Работа с детьми</option>
                        <option value="Медицинские навыки">Медицинские навыки</option>
                        <option value="Преподавание">Преподавание</option>
                        <option value="Фотография">Фотография</option>
                        <option value="Дизайн">Дизайн</option>
                        <option value="IT навыки">IT навыки</option>
